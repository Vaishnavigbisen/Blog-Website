...
import { ThumbDownIcon, ThumbUpIcon, EyeIcon } from "@heroicons/react/solid";
import {
  fetchPostsAction,
...
import { fetchCategoriestAction } from "../../redux/slices/categories/categoriesSlices";
...
export default function PostsList() {
  ...
  const { appErr, serverErr, postLists, dislikes, likes } = posts;
  //Fetch posts
  useEffect(() => {
    dispatch(fetchPostsAction(""));
  }, [likes, dislikes, dispatch]);
